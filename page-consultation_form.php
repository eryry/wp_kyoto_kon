<?php
/*
Template Name: page-consultation_form
*/
?>
...
<section class="consultation-form-main">
  ...
  <div class="consultation-form-flow">
    <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/consultation_form/consultation_form_flow.png" alt="無料カウンセリングお申し込みフォーム">
  </div>
